package com.cloud.authenticationclient.service.impl;


import com.cloud.authenticationclient.provider.AuthProvider;
import com.cloud.authenticationclient.service.IAuthService;
...
//    @Value("${gate.ignore.authentication.startWith}")
    ...
    public boolean ignoreAuthentication(String url) {
        return Stream.of(this.ignoreUrls.split(",")).anyMatch(ignoreUrl -> url.startsWith(org.apache.commons.lang3.StringUtils.trim(ignoreUrl)));
    }
    ...
    public Jwt getJwt(String authentication) {
        return JwtHelper.decode(org.apache.commons.lang3.StringUtils.substring(authentication, BEARER_BEGIN_INDEX));
    }
}